...
description: Magic Quadrant for Intelligent Document Processing
hide_menu: true
---
...
<a href="/docs/2026/intelligent-document-processing.pdf" target="_blank" rel="noopener noreferrer">here</a>
and view the magic quadrant graphic
<a href="/docs/2026/intelligent-document-processing.png" target="_blank" rel="noopener noreferrer">here</a>.

| Market Status   | Market Vendor                                          |
| --------------- | ------------------------------------------------------ |
| `Leader`        | [Hyperscience](/vendors/hyperscience.md)               |
| `Leader`        | [UiPath](/vendors/uipath.md)                           |
| `Leader`        | [Tungsten Automation](/vendors/tungsten-automation.md) |
| `Leader`        | [ABBYY](/vendors/abbyy.md)                             |
| `Leader`        | [Infrrd](/vendors/infrrd.md)                           |
| `Visionary`     | [Appian](/vendors/appian.md)                           |
| `Visionary`     | [Hyland](/vendors/hyland.md)                           |
...
| `Challenger`    | [Iron Mountain](/vendors/iron-mountain.md)             |
