...
description: Magic Quadrant for Sales Performance Management
hide_menu: true
---
...
<a href="/docs/2026/sales-performance-management.pdf" target="_blank" rel="noopener noreferrer">here</a>
and view the magic quadrant graphic
<a href="/docs/2026/sales-performance-management.png" target="_blank" rel="noopener noreferrer">here</a>.

| MQ Position    | MQ Vendor                              |
| -------------- | -------------------------------------- |
| `Leader`       | [Anaplan](/vendors/anaplan.md)         |
| `Leader`       | [Xactly](/vendors/xactly.md)           |
| `Leader`       | [Varicent](/vendors/varicent.md)       |
| `Leader`       | [CaptivateIQ](/vendors/captivateiq.md) |
| `Leader`       | [Salesforce](/vendors/salesforce.md)   |
| `Visionary`    | [Forma.ai](/vendors/forma.ai.md)       |
| `Visionary`    | [SAP](/vendors/sap.md)                 |
| `Niche Player` | [Pigment](/vendors/pigment.md)         |
| `Niche Player` | [Fullcast](/vendors/fullcast.md)       |
| `Niche Player` | [Oracle](/vendors/oracle.md)           |
| `Niche Player` | [Akeron](/vendors/akeron.md)           |
| `Challenger`   | [Everstage](/vendors/everstage.md)     |
| `Challenger`   | [Performio](/vendors/performio.md)     |
